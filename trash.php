...
if(isset($_GET['restor_id'])){
    $restor_id = $_GET['restor_id'];
    $sql = "UPDATE dev SET trash=:trash,status=:status WHERE id = '$restor_id'";
    $statement = connect()->prepare($sql);
    $statement->execute([
        ":trash" => '0',
        ":status" => '1'
    ]);
    setMessage("deletMsg", "Data Restor Successfully");
    header("location:trash.php");
}

if (isset($_GET['deletId'])) {
    $deletId = $_GET['deletId'];
    $deletImg = $_GET['deletImg'];
    print_r( $deletImg);

    $sql  = "DELETE FROM dev WHERE id = '$deletId'";
    $statement = connect()->prepare($sql);
    $statement->execute();
    unlink(__DIR__ . "/media/devs/" . $deletImg);

    setMessage("deletMsg", "Data Deleted Successfully");
    header("location:trash.php");
}
                        ...
                        <div class="card-body">
                            ...
                            <table class=" table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $params[':trashNumbar']='1';
                                    $conditions[]="status= :statusNumbar";
                                    $params[':statusNumbar'] = '0';
                                    ...
                                    ?>
                                        ...
                                        <tr class="  align-middle text-center">
                                            ...
                                            <td>
                                                <a class=" btn btn-sm btn-danger" href="trash.php?restor_id=<?php echo $itam->id ?>"><i class="fa-solid fa-thumbs-down"></i></a>
                                            </td>
                                            <td>
                                                ...
                                                <a class=" btn btn-sm btn-danger" href="trash.php?deletId=<?php echo $itam->id?>&deletImg=<?php echo $itam->image?>"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
